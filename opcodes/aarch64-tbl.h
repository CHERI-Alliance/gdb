...
/* e.g. LDR <Dt>, [<Ct|CSP>, <Xm|Wm>{, <extend> {#<amount>}}].  */
#define QL2_A64C_FP_CAPADDR		\
{				\
  QLF2(S_S,S_S),		\
  QLF2(S_D,S_D),		\
}
...
const struct aarch64_opcode aarch64_opcode_table[] =
{
  ...
  CORE_INSN ("br", 0xd61f0000, 0xfffffc1f, branch_reg, 0, OP1 (Rn), QL_I1X, F_SUBCLASS_OTHER |F_NONC64),
  CORE_INSN ("blr", 0xd63f0000, 0xfffffc1f, branch_reg, 0, OP1 (Rn), QL_I1X, F_BRANCH_CALL | F_NONC64),
  CORE_INSN ("ret", 0xd65f0000, 0xfffffc1f, branch_reg, 0, OP1 (Rn), QL_I1X, F_BRANCH_RET | F_OPD0_OPT | F_DEFAULT (30) | F_NONC64),
  ...
  A64C_INSN ("ldr", 0xc2400000, 0xffc00000, ldst_pos, OP_LDR_POS_C, OP2 (Cat, ADDR_UIMM12), QL2_A64C_CA_ADDR, 0),
  A64C_INSN ("str", 0xc2000000, 0xffc00000, ldst_pos, OP_STR_POS_C, OP2 (Cat, ADDR_UIMM12), QL2_A64C_CA_ADDR, 0),
  ...
  /* These are aliases of LDUR and STUR:  */
  A64C_INSN ("ldr", 0xe2200400, 0xff200c00, ldst_altbase, OP_LDRFP_POS_A, OP2 (Fsz, CAPADDR_SIMM9), QL_S_2SAME, F_ALIAS),
  A64C_INSN ("str", 0xe2200000, 0xff200c00, ldst_altbase, OP_STRFP_POS_A, OP2 (Fsz, CAPADDR_SIMM9), QL_S_2SAME, F_ALIAS),
  A64C_INSN ("ldr", 0xe2200c00, 0xffe00c00, ldst_altbase, OP_LDRFPQ_POS_A, OP2 (St, CAPADDR_SIMM9), QL_I2SAMEQ, F_ALIAS),
  A64C_INSN ("str", 0xe2200800, 0xffe00c00, ldst_altbase, OP_STRFPQ_POS_A, OP2 (St, CAPADDR_SIMM9), QL_I2SAMEQ, F_ALIAS),

  A64C_INSN ("str", 0x82400000, 0xffe00c00, ldst_altbase, OP_STR_POS_AC, OP2 (Cat, CAPADDR_UIMM9), QL2_A64C_CA_CAPADDR, 0),
  A64C_INSN ("str", 0x82400800, 0xffe00800, ldst_altbase, OP_STR_POS_AX, OP2 (Rsz, CAPADDR_UIMM9), QL2_A64C_R_CAPADDR, 0),
  ...
  A64C_INSN ("ldur", 0xe2c00c00, 0xffe00c00, ldst_altbase, OP_LDUR_AC, OP2 (Cat, CAPADDR_SIMM9), QL2_A64C_CA_CAPADDR, 0),
  A64C_INSN ("ldur", 0xe2800400, 0xffa00c00, ldst_altbase, OP_LDUR_AX, OP2 (Rsz2, CAPADDR_SIMM9), QL2_A64C_R_CAPADDR, 0),
  A64C_INSN ("ldur", 0xe2200400, 0xff200c00, ldst_altbase, OP_LDURFP_A, OP2 (Fsz, CAPADDR_SIMM9), QL_S_2SAME, F_HAS_ALIAS | F_P1),
  A64C_INSN ("ldur", 0xe2200c00, 0xffe00c00, ldst_altbase, OP_LDURFPQ_POS_A, OP2 (St, CAPADDR_SIMM9), QL_I2SAMEQ, F_HAS_ALIAS | F_P1),
  A64C_INSN ("stur", 0xe2800c00, 0xffe00c00, ldst_altbase, OP_STUR_AC, OP2 (Cat, CAPADDR_SIMM9), QL2_A64C_CA_CAPADDR, 0),
  A64C_INSN ("stur", 0xe2800000, 0xffa00c00, ldst_altbase, OP_STUR_AX, OP2 (Rsz2, CAPADDR_SIMM9), QL2_A64C_R_CAPADDR, 0),
...
#define AARCH64_OPERANDS						\
    ...
    Y(ADDRESS, addr_uimm, "ADDR_UIMM12", 0, F(FLD_Rn,FLD_imm12),	\
