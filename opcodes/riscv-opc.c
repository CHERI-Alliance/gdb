...
/* Double-precision floating-point instruction subset.  */
{"fld",      32, INSN_CLASS_ZCD, "D,Cn(WCCc)", MATCH_C_FLDSP, MASK_C_FLDSP, match_opcode, INSN_ALIAS|INSN_DREF|INSN_8_BYTE },
{"fld",      32, INSN_CLASS_ZCD, "CD,Cl(WCCs)", MATCH_C_FLD, MASK_C_FLD, match_opcode, INSN_ALIAS|INSN_DREF|INSN_8_BYTE },
{"fld",       0, INSN_CLASS_D,   "D,o(WCs)",   MATCH_FLD, MASK_FLD, match_opcode, INSN_DREF|INSN_8_BYTE },
{"fsd",      32, INSN_CLASS_ZCD, "CT,CN(WCCc)", MATCH_C_FSDSP, MASK_C_FSDSP, match_opcode, INSN_ALIAS|INSN_DREF|INSN_8_BYTE },
{"fsd",      32, INSN_CLASS_ZCD, "CD,Cl(WCCs)", MATCH_C_FSD, MASK_C_FSD, match_opcode, INSN_ALIAS|INSN_DREF|INSN_8_BYTE },
