...
static aarch64_feature_set arch_variant_c64;
static enum map_type last_type;
static int last_mapping_sym = -1;
static bfd_vma last_stop_offset = 0;
static bfd_vma last_mapping_addr = 0;

#define MAYBE_C64 (last_type == MAP_TYPE_C64)
...
select_aarch64_variant (unsigned mach)
{
  switch (mach)
    ...
    default:
      ...
      arch_variant_c64 = arch_variant;
      AARCH64_CLEAR_FEATURE (arch_variant, arch_variant, C64);
    }
}
