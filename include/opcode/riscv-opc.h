...
#define MATCH_GCTYPE 0x10200033
#define MASK_GCTYPE 0xfff0707f
...
#define MATCH_C_MODESW 0x9c7d
#define MASK_C_MODESW 0xffff
...
DECLARE_INSN(gcmode, MATCH_GCMODE, MASK_GCMODE)
DECLARE_INSN(gcperm, MATCH_GCPERM, MASK_GCPERM)
DECLARE_INSN(gctag, MATCH_GCTAG, MASK_GCTAG)
DECLARE_INSN(gctype, MATCH_GCTYPE, MASK_GCTYPE)
DECLARE_INSN(modesw_cap, MATCH_MODESW_CAP, MASK_MODESW_CAP)
DECLARE_INSN(modesw_int, MATCH_MODESW_INT, MASK_MODESW_INT)
...
DECLARE_CSR(stval2, CSR_STVAL2, CSR_CLASS_I, PRIV_SPEC_CLASS_1P10, PRIV_SPEC_CLASS_DRAFT)
...
DECLARE_CSR(htval2, CSR_HTVAL2, CSR_CLASS_H, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
...
DECLARE_CSR(vstval2, CSR_VSTVAL2, CSR_CLASS_H, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
...
#ifdef DECLARE_CSR_CHERI
DECLARE_CSR_CHERI(dpcc, CSR_DPC)
DECLARE_CSR_CHERI(dscratch0c, CSR_DSCRATCH0)
DECLARE_CSR_CHERI(dscratch1c, CSR_DSCRATCH1)

DECLARE_CSR_CHERI(mtvecc, CSR_MTVEC)
DECLARE_CSR_CHERI(mscratchc, CSR_MSCRATCH)
DECLARE_CSR_CHERI(mepcc, CSR_MEPC)

DECLARE_CSR_CHERI(stvecc, CSR_STVEC)
DECLARE_CSR_CHERI(sscratchc, CSR_SSCRATCH)
DECLARE_CSR_CHERI(sepcc, CSR_SEPC)

DECLARE_CSR_CHERI(dddc, CSR_DDDC)
DECLARE_CSR_CHERI(mtdc, CSR_MTDC)
DECLARE_CSR_CHERI(stdc, CSR_STDC)
DECLARE_CSR_CHERI(ddc, CSR_DDC)
DECLARE_CSR_CHERI(dinfc, CSR_DINFC)
DECLARE_CSR_CHERI(utidc, CSR_UTIDC)
DECLARE_CSR_CHERI(stidc, CSR_STIDC)
#endif /* DECLARE_CSR_CHERI */
