...
/* Xcheri instructions.  */
#define MATCH_CGETPERM 0xfe00005b
#define MASK_CGETPERM  0xfff0707f
#define MATCH_CGETTYPE 0xfe10005b
#define MASK_CGETTYPE  0xfff0707f
#define MATCH_CGETBASE 0xfe20005b
#define MASK_CGETBASE  0xfff0707f
#define MATCH_CGETLEN 0xfe30005b
#define MASK_CGETLEN  0xfff0707f
#define MATCH_CGETTAG 0xfe40005b
#define MASK_CGETTAG  0xfff0707f
#define MATCH_CGETSEALED 0xfe50005b
#define MASK_CGETSEALED  0xfff0707f
#define MATCH_CGETOFFSET 0xfe60005b
#define MASK_CGETOFFSET  0xfff0707f
#define MATCH_CGETFLAGS 0xfe70005b
#define MASK_CGETFLAGS  0xfff0707f
#define MATCH_CGETADDR 0xfef0005b
#define MASK_CGETADDR  0xfff0707f
#define MATCH_CSEAL 0x1600005b
#define MASK_CSEAL  0xfe00707f
#define MATCH_CSEALENTRY 0xff10005b
#define MASK_CSEALENTRY  0xfff0707f
#define MATCH_CUNSEAL 0x1800005b
#define MASK_CUNSEAL  0xfe00707f
#define MATCH_CANDPERM 0x1a00005b
#define MASK_CANDPERM  0xfe00707f
#define MATCH_CSETFLAGS 0x1c00005b
#define MASK_CSETFLAGS  0xfe00707f
#define MATCH_CSETOFFSET 0x1e00005b
#define MASK_CSETOFFSET  0xfe00707f
#define MATCH_CSETADDR 0x2000005b
#define MASK_CSETADDR  0xfe00707f
#define MATCH_CINCOFFSET 0x2200005b
#define MASK_CINCOFFSET  0xfe00707f
#define MATCH_CINCOFFSETIMMEDIATE 0x105b
#define MASK_CINCOFFSETIMMEDIATE  0x707f
#define MATCH_CSETBOUNDS 0x1000005b
#define MASK_CSETBOUNDS  0xfe00707f
#define MATCH_CSETBOUNDSEXACT 0x1200005b
#define MASK_CSETBOUNDSEXACT  0xfe00707f
#define MATCH_CSETBOUNDSIMMEDIATE 0x205b
#define MASK_CSETBOUNDSIMMEDIATE  0x707f
#define MATCH_CCLEARTAG 0xfeb0005b
#define MASK_CCLEARTAG  0xfff0707f
#define MATCH_CBUILDCAP 0x3a00005b
#define MASK_CBUILDCAP  0xfe00707f
#define MATCH_CCOPYTYPE 0x3c00005b
#define MASK_CCOPYTYPE  0xfe00707f
#define MATCH_CCSEAL 0x3e00005b
#define MASK_CCSEAL  0xfe00707f
#define MATCH_CTOPTR 0x2400005b
...
#define MATCH_CMOVE 0xfea0005b
#define MASK_CMOVE  0xfff0707f
#define MATCH_CTESTSUBSET 0x4000005b
#define MASK_CTESTSUBSET  0xfe00707f
#define MATCH_CSETEQUALEXACT 0x4200005b
#define MASK_CSETEQUALEXACT  0xfe00707f
#define MATCH_CINVOKE 0xfc0000db
#define MASK_CINVOKE  0xfe007fff
#define MATCH_CSPECIALRW 0x200005b
#define MASK_CSPECIALRW  0xfe00707f
#define MATCH_CROUNDREPRESENTABLELENGTH 0xfe80005b
#define MASK_CROUNDREPRESENTABLELENGTH  0xfff0707f
#define MATCH_CREPRESENTABLEALIGNMENTMASK 0xfe90005b
#define MASK_CREPRESENTABLEALIGNMENTMASK  0xfff0707f
#define MATCH_JALR_CAP 0xfec0005b
#define MASK_JALR_CAP  0xfff0707f
#define MATCH_LB_DDC 0xfa00005b
#define MASK_LB_DDC  0xfff0707f
#define MATCH_LH_DDC 0xfa10005b
#define MASK_LH_DDC  0xfff0707f
#define MATCH_LW_DDC 0xfa20005b
#define MASK_LW_DDC  0xfff0707f
#define MATCH_LD_DDC 0xfa30005b
#define MASK_LD_DDC  0xfff0707f
#define MATCH_LQ_DDC 0xfb70005b
#define MASK_LQ_DDC  0xfff0707f
#define MATCH_LBU_DDC 0xfa40005b
#define MASK_LBU_DDC  0xfff0707f
#define MATCH_LHU_DDC 0xfa50005b
#define MASK_LHU_DDC  0xfff0707f
#define MATCH_LWU_DDC 0xfa60005b
#define MASK_LWU_DDC  0xfff0707f
#define MATCH_LDU_DDC 0xfa70005b
#define MASK_LDU_DDC  0xfff0707f
#define MATCH_LB_CAP 0xfa80005b
#define MASK_LB_CAP  0xfff0707f
#define MATCH_LH_CAP 0xfa90005b
#define MASK_LH_CAP  0xfff0707f
#define MATCH_LW_CAP 0xfaa0005b
#define MASK_LW_CAP  0xfff0707f
#define MATCH_LD_CAP 0xfab0005b
#define MASK_LD_CAP  0xfff0707f
#define MATCH_LQ_CAP 0xfbf0005b
#define MASK_LQ_CAP  0xfff0707f
#define MATCH_LBU_CAP 0xfac0005b
#define MASK_LBU_CAP  0xfff0707f
#define MATCH_LHU_CAP 0xfad0005b
#define MASK_LHU_CAP  0xfff0707f
#define MATCH_LWU_CAP 0xfae0005b
#define MASK_LWU_CAP  0xfff0707f
#define MATCH_LDU_CAP 0xfaf0005b
#define MASK_LDU_CAP  0xfff0707f
#define MATCH_LR_B_DDC 0xfb00005b
#define MASK_LR_B_DDC  0xfff0707f
#define MATCH_LR_H_DDC 0xfb10005b
#define MASK_LR_H_DDC  0xfff0707f
#define MATCH_LR_W_DDC 0xfb20005b
#define MASK_LR_W_DDC  0xfff0707f
#define MATCH_LR_D_DDC 0xfb30005b
#define MASK_LR_D_DDC  0xfff0707f
#define MATCH_LR_Q_DDC 0xfb40005b
#define MASK_LR_Q_DDC  0xfff0707f
#define MATCH_LR_B_CAP 0xfb80005b
#define MASK_LR_B_CAP  0xfff0707f
#define MATCH_LR_H_CAP 0xfb90005b
#define MASK_LR_H_CAP  0xfff0707f
#define MATCH_LR_W_CAP 0xfba0005b
#define MASK_LR_W_CAP  0xfff0707f
#define MATCH_LR_D_CAP 0xfbb0005b
#define MASK_LR_D_CAP  0xfff0707f
#define MATCH_LR_Q_CAP 0xfbc0005b
#define MASK_LR_Q_CAP  0xfff0707f
#define MATCH_SB_DDC 0xf800005b
#define MASK_SB_DDC  0xfe007fff
#define MATCH_SH_DDC 0xf80000db
#define MASK_SH_DDC  0xfe007fff
#define MATCH_SW_DDC 0xf800015b
#define MASK_SW_DDC  0xfe007fff
#define MATCH_SD_DDC 0xf80001db
#define MASK_SD_DDC  0xfe007fff
#define MATCH_SQ_DDC 0xf800025b
#define MASK_SQ_DDC  0xfe007fff
#define MATCH_SB_CAP 0xf800045b
#define MASK_SB_CAP  0xfe007fff
#define MATCH_SH_CAP 0xf80004db
#define MASK_SH_CAP  0xfe007fff
#define MATCH_SW_CAP 0xf800055b
#define MASK_SW_CAP  0xfe007fff
#define MATCH_SD_CAP 0xf80005db
#define MASK_SD_CAP  0xfe007fff
#define MATCH_SQ_CAP 0xf800065b
#define MASK_SQ_CAP  0xfe007fff
#define MATCH_SC_B_DDC 0xf800085b
#define MASK_SC_B_DDC  0xfe007fff
#define MATCH_SC_H_DDC 0xf80008db
#define MASK_SC_H_DDC  0xfe007fff
#define MATCH_SC_W_DDC 0xf800095b
#define MASK_SC_W_DDC  0xfe007fff
#define MATCH_SC_D_DDC 0xf80009db
#define MASK_SC_D_DDC  0xfe007fff
#define MATCH_SC_Q_DDC 0xf8000a5b
#define MASK_SC_Q_DDC  0xfe007fff
#define MATCH_SC_B_CAP 0xf8000c5b
#define MASK_SC_B_CAP  0xfe007fff
#define MATCH_SC_H_CAP 0xf8000cdb
#define MASK_SC_H_CAP  0xfe007fff
#define MATCH_SC_W_CAP 0xf8000d5b
#define MASK_SC_W_CAP  0xfe007fff
#define MATCH_SC_D_CAP 0xf8000ddb
#define MASK_SC_D_CAP  0xfe007fff
#define MATCH_SC_Q_CAP 0xf8000e5b
#define MASK_SC_Q_CAP  0xfe007fff
#define MATCH_LQ 0x200f
...
/* Xcheri instructions.  */
DECLARE_INSN(cgetperm, MATCH_CGETPERM, MASK_CGETPERM)
DECLARE_INSN(cgettype, MATCH_CGETTYPE, MASK_CGETTYPE)
DECLARE_INSN(cgetbase, MATCH_CGETBASE, MASK_CGETBASE)
DECLARE_INSN(cgetlen, MATCH_CGETLEN, MASK_CGETLEN)
DECLARE_INSN(cgettag, MATCH_CGETTAG, MASK_CGETTAG)
DECLARE_INSN(cgetsealed, MATCH_CGETSEALED, MASK_CGETSEALED)
DECLARE_INSN(cgetoffset, MATCH_CGETOFFSET, MASK_CGETOFFSET)
DECLARE_INSN(cgetflags, MATCH_CGETFLAGS, MASK_CGETFLAGS)
DECLARE_INSN(cgetaddr, MATCH_CGETADDR, MASK_CGETADDR)
DECLARE_INSN(cseal, MATCH_CSEAL, MASK_CSEAL)
DECLARE_INSN(csealentry, MATCH_CSEALENTRY, MASK_CSEALENTRY)
DECLARE_INSN(cunseal, MATCH_CUNSEAL, MASK_CUNSEAL)
DECLARE_INSN(candperm, MATCH_CANDPERM, MASK_CANDPERM)
DECLARE_INSN(csetflags, MATCH_CSETFLAGS, MASK_CSETFLAGS)
DECLARE_INSN(csetoffset, MATCH_CSETOFFSET, MASK_CSETOFFSET)
DECLARE_INSN(csetaddr, MATCH_CSETADDR, MASK_CSETADDR)
DECLARE_INSN(cincoffset, MATCH_CINCOFFSET, MASK_CINCOFFSET)
DECLARE_INSN(cincoffsetimmediate, MATCH_CINCOFFSETIMMEDIATE, MASK_CINCOFFSETIMMEDIATE)
DECLARE_INSN(csetbounds, MATCH_CSETBOUNDS, MASK_CSETBOUNDS)
DECLARE_INSN(csetboundsexact, MATCH_CSETBOUNDSEXACT, MASK_CSETBOUNDSEXACT)
DECLARE_INSN(csetboundsimmediate, MATCH_CSETBOUNDSIMMEDIATE, MASK_CSETBOUNDSIMMEDIATE)
DECLARE_INSN(ccleartag, MATCH_CCLEARTAG, MASK_CCLEARTAG)
DECLARE_INSN(cbuildcap, MATCH_CBUILDCAP, MASK_CBUILDCAP)
DECLARE_INSN(ccopytype, MATCH_CCOPYTYPE, MASK_CCOPYTYPE)
DECLARE_INSN(ccseal, MATCH_CCSEAL, MASK_CCSEAL)
DECLARE_INSN(ctoptr, MATCH_CTOPTR, MASK_CTOPTR)
DECLARE_INSN(cfromptr, MATCH_CFROMPTR, MASK_CFROMPTR)
DECLARE_INSN(csub, MATCH_CSUB, MASK_CSUB)
DECLARE_INSN(cmove, MATCH_CMOVE, MASK_CMOVE)
DECLARE_INSN(ctestsubset, MATCH_CTESTSUBSET, MASK_CTESTSUBSET)
DECLARE_INSN(csetequalexact, MATCH_CSETEQUALEXACT, MASK_CSETEQUALEXACT)
DECLARE_INSN(jalr_cap, MATCH_JALR_CAP, MASK_JALR_CAP)
DECLARE_INSN(cinvoke, MATCH_CINVOKE, MASK_CINVOKE)
DECLARE_INSN(cspecialrw, MATCH_CSPECIALRW, MASK_CSPECIALRW)
DECLARE_INSN(croundrepresentablelength, MATCH_CROUNDREPRESENTABLELENGTH, MASK_CROUNDREPRESENTABLELENGTH)
DECLARE_INSN(crepresentablealignmentmask, MATCH_CREPRESENTABLEALIGNMENTMASK, MASK_CREPRESENTABLEALIGNMENTMASK)
DECLARE_INSN(lb_ddc, MATCH_LB_DDC, MASK_LB_DDC)
DECLARE_INSN(lh_ddc, MATCH_LH_DDC, MASK_LH_DDC)
DECLARE_INSN(lw_ddc, MATCH_LW_DDC, MASK_LW_DDC)
DECLARE_INSN(ld_ddc, MATCH_LD_DDC, MASK_LD_DDC)
DECLARE_INSN(lq_ddc, MATCH_LQ_DDC, MASK_LQ_DDC)
DECLARE_INSN(lbu_ddc, MATCH_LBU_DDC, MASK_LBU_DDC)
DECLARE_INSN(lhu_ddc, MATCH_LHU_DDC, MASK_LHU_DDC)
DECLARE_INSN(lwu_ddc, MATCH_LWU_DDC, MASK_LWU_DDC)
DECLARE_INSN(ldu_ddc, MATCH_LDU_DDC, MASK_LDU_DDC)
DECLARE_INSN(lb_cap, MATCH_LB_CAP, MASK_LB_CAP)
DECLARE_INSN(lh_cap, MATCH_LH_CAP, MASK_LH_CAP)
DECLARE_INSN(lw_cap, MATCH_LW_CAP, MASK_LW_CAP)
DECLARE_INSN(ld_cap, MATCH_LD_CAP, MASK_LD_CAP)
DECLARE_INSN(lq_cap, MATCH_LQ_CAP, MASK_LQ_CAP)
DECLARE_INSN(lbu_cap, MATCH_LBU_CAP, MASK_LBU_CAP)
DECLARE_INSN(lhu_cap, MATCH_LHU_CAP, MASK_LHU_CAP)
DECLARE_INSN(lwu_cap, MATCH_LWU_CAP, MASK_LWU_CAP)
DECLARE_INSN(ldu_cap, MATCH_LDU_CAP, MASK_LDU_CAP)
DECLARE_INSN(lr_b_ddc, MATCH_LR_B_DDC, MASK_LR_B_DDC)
DECLARE_INSN(lr_h_ddc, MATCH_LR_H_DDC, MASK_LR_H_DDC)
DECLARE_INSN(lr_w_ddc, MATCH_LR_W_DDC, MASK_LR_W_DDC)
DECLARE_INSN(lr_d_ddc, MATCH_LR_D_DDC, MASK_LR_D_DDC)
DECLARE_INSN(lr_q_ddc, MATCH_LR_Q_DDC, MASK_LR_Q_DDC)
DECLARE_INSN(lr_b_cap, MATCH_LR_B_CAP, MASK_LR_B_CAP)
DECLARE_INSN(lr_h_cap, MATCH_LR_H_CAP, MASK_LR_H_CAP)
DECLARE_INSN(lr_w_cap, MATCH_LR_W_CAP, MASK_LR_W_CAP)
DECLARE_INSN(lr_d_cap, MATCH_LR_D_CAP, MASK_LR_D_CAP)
DECLARE_INSN(lr_q_cap, MATCH_LR_Q_CAP, MASK_LR_Q_CAP)
DECLARE_INSN(sb_ddc, MATCH_SB_DDC, MASK_SB_DDC)
DECLARE_INSN(sh_ddc, MATCH_SH_DDC, MASK_SH_DDC)
DECLARE_INSN(sw_ddc, MATCH_SW_DDC, MASK_SW_DDC)
DECLARE_INSN(sd_ddc, MATCH_SD_DDC, MASK_SD_DDC)
DECLARE_INSN(sq_ddc, MATCH_SQ_DDC, MASK_SQ_DDC)
DECLARE_INSN(sb_cap, MATCH_SB_CAP, MASK_SB_CAP)
DECLARE_INSN(sh_cap, MATCH_SH_CAP, MASK_SH_CAP)
DECLARE_INSN(sw_cap, MATCH_SW_CAP, MASK_SW_CAP)
DECLARE_INSN(sd_cap, MATCH_SD_CAP, MASK_SD_CAP)
DECLARE_INSN(sq_cap, MATCH_SQ_CAP, MASK_SQ_CAP)
DECLARE_INSN(sc_b_ddc, MATCH_SC_B_DDC, MASK_SC_B_DDC)
DECLARE_INSN(sc_h_ddc, MATCH_SC_H_DDC, MASK_SC_H_DDC)
DECLARE_INSN(sc_w_ddc, MATCH_SC_W_DDC, MASK_SC_W_DDC)
DECLARE_INSN(sc_d_ddc, MATCH_SC_D_DDC, MASK_SC_D_DDC)
DECLARE_INSN(sc_q_ddc, MATCH_SC_Q_DDC, MASK_SC_Q_DDC)
DECLARE_INSN(sc_b_cap, MATCH_SC_B_CAP, MASK_SC_B_CAP)
DECLARE_INSN(sc_h_cap, MATCH_SC_H_CAP, MASK_SC_H_CAP)
DECLARE_INSN(sc_w_cap, MATCH_SC_W_CAP, MASK_SC_W_CAP)
DECLARE_INSN(sc_d_cap, MATCH_SC_D_CAP, MASK_SC_D_CAP)
DECLARE_INSN(sc_q_cap, MATCH_SC_Q_CAP, MASK_SC_Q_CAP)
...
#ifdef DECLARE_CHERI_SCR
DECLARE_CHERI_SCR(pcc, CHERI_SCR_PCC)
DECLARE_CHERI_SCR(ddc, CHERI_SCR_DDC)
DECLARE_CHERI_SCR(utcc, CHERI_SCR_UTCC)
DECLARE_CHERI_SCR(utdc, CHERI_SCR_UTDC)
DECLARE_CHERI_SCR(uscratchc, CHERI_SCR_USCRATCHC)
DECLARE_CHERI_SCR(uepcc, CHERI_SCR_UEPCC)
DECLARE_CHERI_SCR(stcc, CHERI_SCR_STCC)
DECLARE_CHERI_SCR(stdc, CHERI_SCR_STDC)
DECLARE_CHERI_SCR(sscratchc, CHERI_SCR_SSCRATCHC)
DECLARE_CHERI_SCR(sepcc, CHERI_SCR_SEPCC)
DECLARE_CHERI_SCR(mtcc, CHERI_SCR_MTCC)
DECLARE_CHERI_SCR(mtdc, CHERI_SCR_MTDC)
DECLARE_CHERI_SCR(mscratchc, CHERI_SCR_MSCRATCHC)
DECLARE_CHERI_SCR(mepcc, CHERI_SCR_MEPCC)
#endif
